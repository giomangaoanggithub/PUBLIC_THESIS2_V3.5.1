...
<body>
    <div class="row">
        <div class="col-2"></div>
        <div class="created-question-section col-8">
            <table>
                <thead>
                    <tr>
                        <th style="width: 60%;">
    ...
    <div class="row">
        <div class="col-2"></div>
        <div class="create-question-input col-8 row">
            <div class="create-question-input-textarea col-10">
                <textarea name="" id="input-create" cols="50" rows="3"
                    placeholder="Write your question here..."></textarea>
                <textarea name="" id="autocheck-textarea" cols="50" rows="3"
                    placeholder="Write your expected answer here... (optional)"></textarea>
            </div>
            <div class="create-question-input-interactives col-2">
