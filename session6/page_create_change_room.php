...
<body>
    <div class="create-change-room row">
        ...
        <div class="create-room-title col-12">
            <h1>
                CREATE CLASSROOM
            </h1>
        </div>
        <div class="create-room-list col-10">
            <table>
                <thead>
                    <tr>
                        <th>
        ...
        <div class="create-interaction col-1">
            <button id="insert-room-btn">GENERATE</button>
        </div>
        <div class="delete-interaction col-5">
        ...
        <div class="delete-interaction col-1">
            <button id="delete-room-btn">DESTROY</button>
        </div>

        <div class="change-room-title col-12">
            <h1>
                CHANGE CLASSROOM
            </h1>
        </div>
        <div class="change-room-param col-12 row">
            <div class="col-2"></div>
            <div class="change-room-content col-8">
                <table>
                    <thead>
                        <tr>
                            <th>
