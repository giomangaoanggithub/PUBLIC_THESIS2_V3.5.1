...
<body>
    <div class="part1 row">
        <div class="nav-bar col-12 row">
            <div class="nav-bar-left col-6">
                Essay Speed Checker
            </div>
            <div class="nav-bar-right col-6 row">
                <div class="col-6"></div>
                <div class="col-6 row">
                    <div class="col-6"><button id="sign-in-btn" class="btn btn-dark btn-lg">SIGN IN</button></div>
                    <div class="col-6"><button id="sign-up-btn" class="btn btn-dark btn-lg">SIGN UP</button></div>
                </div>
            </div>
        </div>
        <div class="content col-12 row">
            <div class="col-4 row">
                <div class="imgd mh-100 col-12">
                    <img src="images/image-1.gif" class="img-fluid" alt="">
                </div>
                <div class="esc-text col-12">
    ...
    <div id="overlay" class="overlay col-12"></div>
    <div id="sign-up-form" class="sign-up-form col-12 row">
        <div class="col-4">
        </div>
        <div class="sign-up-box col-4 row">
            <div class="sign-up-title col-12">
                SIGN UP
            </div>
            <div id="sign-up-content1" class="sign-up-content1 col-12">
                <button id="sel-admin-btn">ADMIN</button>
                <button id="sel-teacher-btn">TEACHER</button>
                <button id="sel-student-btn">STUDENT</button>
            </div>
            <div id="sign-up-s1" class="sign-up-s1 col-12">
                <button id="cancel-btn" class="btn btn-secondary btn-lg">CANCEL</button>
            </div>
            <div id="sign-up-content2" class="sign-up-content2 col-12">
                ADMINISTRATOR<br>
                <input type="text" placeholder="Company Name" id="company-input">
            </div>
            <div id="sign-up-content3" class="sign-up-content3 col-12">
                TEACHER<br>
            </div>
            <div id="sign-up-content4" class="sign-up-content4 col-12">
                STUDENT<br>
            </div>
            <div id="sign-up-content5" class="sign-up-content4 col-12">
            ...
            <div id="sign-up-s2" class="sign-up-s2 col-12">
    ...
    <div id="sign-in-form" class="sign-in-form col-12 row">
        <div class="col-4">
        </div>
        <div class="sign-in-box col-4 row">
            <div class="sign-in-title col-12">
                SIGN IN
            </div>
            <div id="sign-in-content" class="sign-in-content col-12">
            ...
            <div id="sign-in-s1" class="sign-in-s1 col-12">
